...
describe.each(['en-ke', 'sw'])('custom seed variety input handler using (%s)', (lang) => {
    ...
    it('it prompt for lotcode if the input is valid', () => {
        ...
        const messages = {
            ...
            'sw': 'Tafadhali ingiza nambari ya mbegu kwenye pakiti ya mbegu uliyonunua. Nambari hii iko kwenye pakiti y...\n77) Endelea'
        };

        var screens = {
            'sw': '{"1":"Tafadhali ingiza nambari ya mbegu kwenye pakiti ya mbegu uliyonunua. Nambari hii iko kwenye pakiti y...\\n77) Endelea","2":"a mbegu na kawaida huwa na herufi na nambari. Bonyeza 0 ikiwa huwezi kupata nambari."}',
